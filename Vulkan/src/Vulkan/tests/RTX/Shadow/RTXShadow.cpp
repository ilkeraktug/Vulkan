...
{
    Init(core);
    m_Camera = std::make_unique<PerspectiveCamera>(m_Core->swapchain.extent.width, m_Core->swapchain.extent.height,
                                                   core);
...
{
    std::system(
        "@echo off & cd C:\\dev\\Vulkan\\Vulkan\\assets\\shaders\\raytracingshadow & for /r %i in (*.vert) do (%VULKAN_SDK%/Bin/dxc.exe -spirv -Tvs_6_1 -Emain  -fspv-extension=SPV_KHR_ray_query -fspv-extension=SPV_KHR_ray_tracing -fspv-extension=SPV_KHR_multiview -fspv-extension=SPV_KHR_shader_draw_parameters -fspv-extension=SPV_EXT_descriptor_indexing -fspv-target-env=vulkan1.2 %i -Fo C:%~pi%~ni.vspv)");
    std::system(
        "@echo off & cd C:\\dev\\Vulkan\\Vulkan\\assets\\shaders\\raytracingshadow & for /r %i in (*.frag) do (%VULKAN_SDK%/Bin/dxc.exe -spirv -Tps_6_1 -Emain  -fspv-extension=SPV_KHR_ray_query -fspv-extension=SPV_KHR_ray_tracing -fspv-extension=SPV_KHR_multiview -fspv-extension=SPV_KHR_shader_draw_parameters -fspv-extension=SPV_EXT_descriptor_indexing -fspv-target-env=vulkan1.2 %i -Fo C:%~pi%~ni.fspv)");
    std::system(
        "@echo off & cd C:\\dev\\Vulkan\\Vulkan\\assets\\shaders\\raytracingshadow & for %i in (*.rchit) do (%VULKAN_SDK%/Bin/dxc.exe -spirv -Tlib_6_3 -Emain  -fspv-extension=SPV_KHR_ray_query -fspv-extension=SPV_KHR_ray_tracing -fspv-extension=SPV_KHR_multiview -fspv-extension=SPV_KHR_shader_draw_parameters -fspv-extension=SPV_EXT_descriptor_indexing -fspv-target-env=vulkan1.2 %i -Fo %~ni.rchit.spv)");
    std::system(
        "@echo off & cd C:\\dev\\Vulkan\\Vulkan\\assets\\shaders\\raytracingshadow & for %i in (*.rmiss) do (%VULKAN_SDK%/Bin/dxc.exe -spirv -Tlib_6_3 -Emain  -fspv-extension=SPV_KHR_ray_query -fspv-extension=SPV_KHR_ray_tracing -fspv-extension=SPV_KHR_multiview -fspv-extension=SPV_KHR_shader_draw_parameters -fspv-extension=SPV_EXT_descriptor_indexing -fspv-target-env=vulkan1.2 %i -Fo %~ni.rmiss.spv)");
    std::system(
        "@echo off & cd C:\\dev\\Vulkan\\Vulkan\\assets\\shaders\\raytracingshadow & for %i in (*.rgen) do (%VULKAN_SDK%/Bin/dxc.exe -spirv -Tlib_6_3 -Emain   -fspv-extension=SPV_KHR_ray_query -fspv-extension=SPV_KHR_ray_tracing  -fspv-extension=SPV_KHR_multiview -fspv-extension=SPV_KHR_shader_draw_parameters -fspv-extension=SPV_EXT_descriptor_indexing -fspv-target-env=vulkan1.2 %i -Fo %~ni.rgen.spv)");
}
...
void test::RTXShadow::createBottomLevelAccelerationStructure()
{
    ...
    scene.loadFromFile("C:/dev/Vulkan/Vulkan/assets/models/vulkanscene_shadow.gltf", m_Core,
    ...
    vkPFN::vkGetAccelerationStructureBuildSizesKHR(m_Core->GetDevice(), VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR,
                                                   &blasBuildGeometryInfo, &maxPrimitiveCount, &blasBuildSizeInfo);

    VkBufferCreateInfo blasBufferCI = init::createBufferInfo(blasBuildSizeInfo.accelerationStructureSize,
    ...
    blasMemAllocInfo.memoryTypeIndex = m_Core->getMemoryType(blasMemRequirements.memoryTypeBits,
    ...
    VkBufferCreateInfo scratchBufferCI = init::createBufferInfo(blasBuildSizeInfo.buildScratchSize,
    ...
    memAllocInfo.memoryTypeIndex = m_Core->getMemoryType(memRequirements.memoryTypeBits,
                                                         VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
    ...
    scratchBufferDeviceAddress.deviceAddress = vkGetBufferDeviceAddress(
        m_Core->GetDevice(), &scratchBufferDeviceAddressInfo);
    ...
    vkPFN::vkCmdBuildAccelerationStructuresKHR(cmdBuffer, 1, &blasBuildGeometryInfo2,
...
void test::RTXShadow::createBottomLevelAccelerationStructure2()
{
    ...
    scene.loadFromFile("C:/dev/Vulkan/Vulkan/assets/models/vulkanscene_shadow.gltf", m_Core,
                       m_Core->queue.TransferQueue, glTFLoadingFlags);
    scene2.loadFromFile("C:/dev/Vulkan/Vulkan/assets/models/shadowscene_fire.gltf", m_Core, m_Core->queue.TransferQueue,
                        glTFLoadingFlags);
...
void test::RTXShadow::createTopLevelAccelerationStructure()
{
    ...
    tlasInstanceBufferMemAllocInfo.memoryTypeIndex = m_Core->getMemoryType(
        tlasInstanceBufferMemRequirements.memoryTypeBits,
        VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT);

    VK_CHECK(
        vkAllocateMemory(m_Core->GetDevice(), &tlasInstanceBufferMemAllocInfo, nullptr, &tlasInstanceBufferDeviceMemory
        ));
    ...
    VK_CHECK(
        vkMapMemory(m_Core->GetDevice(), tlasInstanceBufferDeviceMemory, 0, sizeof(VkAccelerationStructureInstanceKHR),
            0, &mappedMemory));
    ...
    tlasInstanceBufferDeviceHostAddress.deviceAddress = vkGetBufferDeviceAddress(
        m_Core->GetDevice(), &tlasInstanceDeviceAddressInfo);
    ...
    vkPFN::vkGetAccelerationStructureBuildSizesKHR(m_Core->GetDevice(), VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR,
                                                   &tlasBuildGeometryInfo, &numPrimitive, &tlasBuildSizeInfo);

    VkBufferCreateInfo tlasBufferCI = init::createBufferInfo(tlasBuildSizeInfo.accelerationStructureSize,
                                                             VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR |
                                                             VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT);
    ...
    tlasMemAllocInfo.memoryTypeIndex = m_Core->getMemoryType(tlasBufferMemReqs.memoryTypeBits,
                                                             VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
    ...
    VkBufferCreateInfo scratchBufferCI = init::createBufferInfo(tlasBuildSizeInfo.buildScratchSize,
                                                                VK_BUFFER_USAGE_STORAGE_BUFFER_BIT |
                                                                VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT);
    VkBuffer scratchBuffer;
    ...
    vkPFN::vkCmdBuildAccelerationStructuresKHR(cmdBuffer, 1, &tlasBuildGeometryInfo,
                                               accelerationBuildStructureRangeInfos.data());
    m_Core->flushComputeCommandBuffer(cmdBuffer, m_Core->queue.ComputeQueue);
}
...
{
    VkFormat ImageFormat = VK_FORMAT_R32G32B32A32_SFLOAT;//m_Core->swapchain.colorFormat;
    ...
    imageMemAllocInfo.memoryTypeIndex = m_Core->getMemoryType(imageMemRequirements.memoryTypeBits,
                                                              VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
...
void test::RTXShadow::createUniformBuffer()
{
    ...
    memAllocInfo.memoryTypeIndex = m_Core->getMemoryType(memReqs.memoryTypeBits,
    ...
    VK_CHECK(
        vkMapMemory(m_Core->GetDevice(), m_UniformBuffer.Memory, 0, sizeof(UniformBuffer), 0, &m_UniformBuffer.Data));
}
...
void test::RTXShadow::createRayTracingPipeline()
{
    ...
    {
        init::descriptorSetLayoutBinding(VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR,
                                         VK_SHADER_STAGE_RAYGEN_BIT_KHR | VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR, 0, 1),
    ...
    VK_CHECK(
        vkCreateDescriptorSetLayout(m_Core->GetDevice(), &rtxDescriptorSetLayoutCI, nullptr, &m_RTXDescriptorSetLayout
        ));
    ...
    {
        VkPipelineShaderStageCreateInfo shaderStageCI = VulkanShader::GetShaderModule(
            *m_Core, "C:/dev/Vulkan/Vulkan/assets/shaders/raytracingshadow/raygen.rgen.spv",
    ...
    {
        VkPipelineShaderStageCreateInfo shaderStageCI = VulkanShader::GetShaderModule(
            *m_Core, "C:/dev/Vulkan/Vulkan/assets/shaders/raytracingshadow/miss.rmiss.spv",
    ...
    {
        VkPipelineShaderStageCreateInfo shaderStageCI = VulkanShader::GetShaderModule(
            *m_Core, "C:/dev/Vulkan/Vulkan/assets/shaders/raytracingshadow/miss_shadow.rmiss.spv",
            VK_SHADER_STAGE_MISS_BIT_KHR);
        rtxPipelineShaderStageCIs.push_back(shaderStageCI);
    ...
    {
        VkPipelineShaderStageCreateInfo shaderStageCI = VulkanShader::GetShaderModule(
            *m_Core, "C:/dev/Vulkan/Vulkan/assets/shaders/raytracingshadow/closesthit.rchit.spv",
    ...
    VK_CHECK(
        vkPFN::vkCreateRayTracingPipelinesKHR(m_Core->GetDevice(), VK_NULL_HANDLE, VK_NULL_HANDLE, 1, &rtxPipelineCI,
            nullptr, &m_RTXPipeline));
}

void test::RTXShadow::createPostProcessPipeline()
{
    std::vector<VkDescriptorSetLayoutBinding> descriptorSetLayoutBindings = {
        init::descriptorSetLayoutBinding(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK_SHADER_STAGE_FRAGMENT_BIT, 0, 1)
    };
    ...
    VK_CHECK(
        vkCreateDescriptorSetLayout(m_Core->GetDevice(), &descriptorLayoutCI, nullptr, &m_PostProcess.
            DescriptorSetLayout));
    ...
    {
        VulkanShader::GetShaderModule(m_Core->GetDevice(),
                                      "C:/dev/Vulkan/Vulkan/assets/shaders/raytracingshadow/postprocess/postprocess.vspv",
                                      VK_SHADER_STAGE_VERTEX_BIT),
        VulkanShader::GetShaderModule(m_Core->GetDevice(),
                                      "C:/dev/Vulkan/Vulkan/assets/shaders/raytracingshadow/postprocess/postprocess.fspv",
    ...
    VK_CHECK(
        vkCreateGraphicsPipelines(m_Core->GetDevice(), VK_NULL_HANDLE, 1, &graphicsPipelineCI, nullptr, &m_PostProcess.
            Pipeline));
...
void test::RTXShadow::createShaderBindingTable()
{
    ...
    VK_CHECK(
        vkPFN::vkGetRayTracingShaderGroupHandlesKHR(m_Core->GetDevice(), m_RTXPipeline, 0, shaderGroupCIs.size(),
            shaderGroupSize, shaderGroupData.data()));

    VkBufferCreateInfo raygenShaderBufferCI = init::createBufferInfo(shaderGroupHandleAlignedSize,
                                                                     VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT |
    ...
    VkBufferCreateInfo missShaderBufferCI = init::createBufferInfo(shaderGroupHandleAlignedSize * 2,
                                                                   VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT |
                                                                   VK_BUFFER_USAGE_SHADER_BINDING_TABLE_BIT_KHR);
    ...
    VkBufferCreateInfo cHitShaderBufferCI = init::createBufferInfo(shaderGroupHandleAlignedSize,
                                                                   VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT |
                                                                   VK_BUFFER_USAGE_SHADER_BINDING_TABLE_BIT_KHR);
    ...
    auto raygenShaderBindingTableDeviceAddress = vkGetBufferDeviceAddress(
        m_Core->GetDevice(), &shaderBindingTableAddress);

    shaderBindingTableAddress.buffer = missShaderBuffer;
    auto missShaderBindingTableDeviceAddress =
        vkGetBufferDeviceAddress(m_Core->GetDevice(), &shaderBindingTableAddress);

    shaderBindingTableAddress.buffer = cHitShaderBuffer;
    auto cHitShaderBindingTableDeviceAddress =
        vkGetBufferDeviceAddress(m_Core->GetDevice(), &shaderBindingTableAddress);
...
void test::RTXShadow::createDescriptorSets()
{
    ...
    vkUpdateDescriptorSets(m_Core->GetDevice(), writeDescriptorSets.size(), writeDescriptorSets.data(), 0,
                           VK_NULL_HANDLE);
}
...
void test::RTXShadow::buildCommandBuffers()
{
    ...
    for (int i = 0; i < cmdBuffers.size(); i++)
    {
        ...
        vkCmdBindDescriptorSets(currentCmdBuffer, VK_PIPELINE_BIND_POINT_RAY_TRACING_KHR, m_RTXPipelineLayout, 0, 1,
                                &m_RTXDescriptorSet, 0, nullptr);

        VkStridedDeviceAddressRegionKHR dummyStridedDeviceAddress{};

        vkPFN::vkCmdTraceRaysKHR(currentCmdBuffer,
                                 &raygenShaderDeviceAddressRegion, &missShaderDeviceAddressRegion,
                                 &cHitShaderDeviceAddressRegion, &dummyStridedDeviceAddress,
        ...
        vkCmdCopyImage(currentCmdBuffer, m_OutputImage.Image, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
                       m_Core->swapchain.images[i], VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &copyRegion);
...
{
    m_LightPosition = glm::vec4(cos(glm::radians(timer * 360.0f)) * 40.0f,
