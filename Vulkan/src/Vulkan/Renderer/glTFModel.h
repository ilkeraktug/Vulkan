...
namespace vkglTF
{
	...
	*/
	struct Material {
		...
		Material(VulkanCore* core) : core(core) {};
	...
	*/
	struct Mesh {
		...
		Mesh(VulkanCore* core, glm::mat4 matrix);
		~Mesh();
	};
	...
	*/
	...
	public:
		...
		void loadImages(tinygltf::Model& gltfModel, VulkanCore* core, VkQueue transferQueue);
		void loadMaterials(tinygltf::Model& gltfModel);
		void loadAnimations(tinygltf::Model& gltfModel);
		void loadFromFile(std::string filename, VulkanCore* core, VkQueue transferQueue, uint32_t fileLoadingFlags = vkglTF::FileLoadingFlags::None, float scale = 1.0f);
